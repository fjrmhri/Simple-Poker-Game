  ...
  return (
    <div className="p-4">
      <div className="relative mx-auto max-w-6xl p-6 rounded-[60px] border-4 border-yellow-600 shadow-[0_0_0_6px_#000,0_0_0_12px_#fff,0_0_30px_rgba(255,215,0,0.3)] bg-gradient-to-br from-green-800 via-green-700 to-green-900 text-white font-mono">
          ...
          <div className="flex items-center gap-3">
            <div className="text-[#e5e7eb]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-yellow-400">{ronde}</span>
              </div>
            </div>
          </div>
        ...
        <motion.div
          animate={{
            x: state.indexDealer === 0 ? "50%" : 
                state.indexDealer === 1 ? "0%" : 
                state.indexDealer === 2 ? "100%" : "50%",
            y: state.indexDealer === 0 ? "85%" : 
                state.indexDealer === 1 ? "45%" : 
                state.indexDealer === 2 ? "45%" : "50%"
          }}
